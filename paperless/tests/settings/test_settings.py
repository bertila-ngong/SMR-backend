...
from settings.base import _get_search_language_setting
from settings.base import _parse_paperless_url
from settings.base import default_threads_per_worker
...
class TestThreadCalculation(TestCase):
    def test_workers_threads(self) -> None:
        ...
        for i in range(1, 64):
            with mock.patch(
                "settings.base.multiprocessing.cpu_count",
            ) as cpu_count:
