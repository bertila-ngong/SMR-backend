...
from settings.custom import parse_beat_schedule
from settings.custom import parse_dateparser_languages
from settings.custom import parse_db_settings
from settings.custom import parse_hosting_settings
from settings.custom import parse_ignore_dates
from settings.custom import parse_redis_url
from settings.parsers import get_bool_from_env
from settings.parsers import get_choice_from_env
from settings.parsers import get_float_from_env
from settings.parsers import get_int_from_env
from settings.parsers import get_list_from_env
from settings.parsers import get_path_from_env
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_VERSION": "10",  # match frontend/src/environments/environment.prod.ts
